 ...
 */
declare function previewTip(lineItemInfo: LineItemInfo[], options?: PreviewTipOptions): Promise<PreviewTipResponse & PreviewTipResponseNonNullableFields>;
 ...
 */
declare function getTipByOrderId(orderId: string | null): Promise<GetTipByOrderIdResponse & GetTipByOrderIdResponseNonNullableFields>;
/**
 * Retrieves the tip that's associated with an
 ...
 * @permissionId WIX_TIPS.TIP_READ
 */
declare function getTipByDraftOrderId(draftOrderId: string | null): Promise<GetTipByDraftOrderIdResponse & GetTipByDraftOrderIdResponseNonNullableFields>;
/**
 ...
 */
declare function getTipChoice(purchaseFlowId: string | null): Promise<GetTipChoiceResponse & GetTipChoiceResponseNonNullableFields>;
/**
 ...
 * @applicableIdentity VISITOR
 */
declare function updateTipChoice(tipChoice: TipChoice, options: UpdateTipChoiceOptions): Promise<UpdateTipChoiceResponse & UpdateTipChoiceResponseNonNullableFields>;
 ...
 */
declare function setTipOnOrder(options?: SetTipOnOrderOptions): Promise<SetTipOnOrderResponse & SetTipOnOrderResponseNonNullableFields>;
 ...
 */
declare function removeTipFromOrder(options?: RemoveTipFromOrderOptions): Promise<RemoveTipFromOrderResponse & RemoveTipFromOrderResponseNonNullableFields>;
 ...
 */
declare function addTipDistributionsToOrder(options?: AddTipDistributionsToOrderOptions): Promise<AddTipDistributionsToOrderResponse & AddTipDistributionsToOrderResponseNonNullableFields>;
 ...
 * @permissionId WIX_TIPS.TIP_DISTRIBUTION_READ
 */
declare function sumTipDistributionAmounts(filter: Record<string, any> | null): Promise<SumTipDistributionAmountsResponse>;

export { type ActionEvent, type AddTipDistributionsToOrderOptions, type AddTipDistributionsToOrderRequest, type AddTipDistributionsToOrderRequestIdentifierOneOf, type AddTipDistributionsToOrderResponse, type AddTipDistributionsToOrderResponseNonNullableFields, type ApplyTipDistributionsRequest, type ApplyTipDistributionsResponse, type CatalogReference, type CommonIdentificationData, type CommonIdentificationDataIdOneOf, type CreateTipDistributionsRequest, type CreateTipDistributionsResponse, type CursorPaging, type CursorPagingMetadata, type CursorQuery, type CursorQueryPagingMethodOneOf, type Cursors, type DeleteTipDistributionsRequest, type DeleteTipDistributionsRequestDeleteByOneOf, type DeleteTipDistributionsResponse, type DomainEvent, type DomainEventBodyOneOf, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, type GetTipByDraftOrderIdRequest, type GetTipByDraftOrderIdResponse, type GetTipByDraftOrderIdResponseNonNullableFields, type GetTipByOrderIdRequest, type GetTipByOrderIdResponse, type GetTipByOrderIdResponseNonNullableFields, type GetTipChoiceRequest, type GetTipChoiceResponse, type GetTipChoiceResponseNonNullableFields, type IdentificationData, type IdentificationDataIdOneOf, IdentityType, type LineItemInfo, type MessageEnvelope, type OrderInfo, type OrderInfoIdentifierOneOf, type PreviewTipOptions, type PreviewTipRequest, type PreviewTipResponse, type PreviewTipResponseNonNullableFields, type Price, type PublishTipDistributionsCreatedEventRequest, type PublishTipDistributionsCreatedEventResponse, QueryBy, type QueryTipDistributionsRequest, type QueryTipDistributionsResponse, type QueryTipDistributionsResponseNonNullableFields, type RemoveTipFromOrderOptions, type RemoveTipFromOrderRequest, type RemoveTipFromOrderRequestIdentifierOneOf, type RemoveTipFromOrderResponse, type RemoveTipFromOrderResponseNonNullableFields, type RestoreInfo, type SetTipOnOrderOptions, type SetTipOnOrderRequest, type SetTipOnOrderRequestIdentifierOneOf, type SetTipOnOrderResponse, type SetTipOnOrderResponseNonNullableFields, SortOrder, type Sorting, type Staff, type SumTipDistributionAmountsRequest, type SumTipDistributionAmountsResponse, type Tip, type TipChoice, type TipDistribution, type TipDistributionsCreated, type TipDistributionsQueryBuilder, type TipDistributionsQueryResult, TipType, type Transaction, type UpdateTipChoiceOptions, type UpdateTipChoiceRequest, type UpdateTipChoiceResponse, type UpdateTipChoiceResponseNonNullableFields, WebhookIdentityType, addTipDistributionsToOrder, getTipByDraftOrderId, getTipByOrderId, getTipChoice, previewTip, queryTipDistributions, removeTipFromOrder, setTipOnOrder, sumTipDistributionAmounts, updateTipChoice };
