 ...
 */
export declare function previewTip(lineItemInfo: LineItemInfo[], options?: PreviewTipOptions): Promise<PreviewTipResponse & PreviewTipResponseNonNullableFields>;
 ...
 */
export declare function getTipByOrderId(orderId: string | null): Promise<GetTipByOrderIdResponse & GetTipByOrderIdResponseNonNullableFields>;
/**
 * Retrieves the tip that's associated with an
 ...
 * @permissionId WIX_TIPS.TIP_READ
 */
export declare function getTipByDraftOrderId(draftOrderId: string | null): Promise<GetTipByDraftOrderIdResponse & GetTipByDraftOrderIdResponseNonNullableFields>;
/**
 ...
 */
export declare function getTipChoice(purchaseFlowId: string | null): Promise<GetTipChoiceResponse & GetTipChoiceResponseNonNullableFields>;
/**
 ...
 * @applicableIdentity VISITOR
 */
export declare function updateTipChoice(tipChoice: TipChoice, options: UpdateTipChoiceOptions): Promise<UpdateTipChoiceResponse & UpdateTipChoiceResponseNonNullableFields>;
 ...
 */
export declare function setTipOnOrder(options?: SetTipOnOrderOptions): Promise<SetTipOnOrderResponse & SetTipOnOrderResponseNonNullableFields>;
export interface SetTipOnOrderOptions extends SetTipOnOrderRequestIdentifierOneOf {
    /** ID of the order for which to set the tip. */
    orderId?: string | null;
    /** Tip to set on the order. */
    tip: Tip;
 ...
 */
export declare function removeTipFromOrder(options?: RemoveTipFromOrderOptions): Promise<RemoveTipFromOrderResponse & RemoveTipFromOrderResponseNonNullableFields>;
export interface RemoveTipFromOrderOptions extends RemoveTipFromOrderRequestIdentifierOneOf {
    /** ID of the order from which to remove the tip. */
    orderId?: string | null;
}
/**
 ...
 */
export declare function addTipDistributionsToOrder(options?: AddTipDistributionsToOrderOptions): Promise<AddTipDistributionsToOrderResponse & AddTipDistributionsToOrderResponseNonNullableFields>;
export interface AddTipDistributionsToOrderOptions extends AddTipDistributionsToOrderRequestIdentifierOneOf {
    /** ID of the order for which to add tip distributions. */
    orderId?: string | null;
    /** Tip distributions to add to the order. */
    tipDistributions: TipDistribution[];
 ...
 * @permissionId WIX_TIPS.TIP_DISTRIBUTION_READ
 */
export declare function sumTipDistributionAmounts(filter: Record<string, any> | null): Promise<SumTipDistributionAmountsResponse>;
export {};
