import { CalculateAdditionalFeesResponse } from './src/service-plugins-types';
import { CalculateAdditionalFeesEnvelope } from './src/interfaces-ecommerce-v1-additional-fees-provider.public';
export * from './src/service-plugins-types';
export { CalculateAdditionalFeesEnvelope };
/**
 ...
 */
export declare function calculateAdditionalFees(payload: CalculateAdditionalFeesEnvelope): CalculateAdditionalFeesResponse | Promise<CalculateAdditionalFeesResponse>;
