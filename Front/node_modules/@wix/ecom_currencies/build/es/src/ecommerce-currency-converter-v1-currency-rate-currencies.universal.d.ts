...
export interface ListCurrenciesResponseNonNullableFields {
...
export interface ConvertCurrencyResponseNonNullableFields {
    amounts: DecimalValueNonNullableFields[];
}
export interface ConversionRateResponseNonNullableFields {
 ...
 */
export declare function listCurrencies(): Promise<ListCurrenciesResponse & ListCurrenciesResponseNonNullableFields>;
/**
 ...
 * @applicableIdentity APP
 */
export declare function convertCurrency(identifiers: ConvertCurrencyIdentifiers, amounts: DecimalValue[]): Promise<ConvertCurrencyResponse & ConvertCurrencyResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
export declare function getConversionRate(identifiers: GetConversionRateIdentifiers): Promise<ConversionRateResponse & ConversionRateResponseNonNullableFields>;
