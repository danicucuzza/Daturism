 ...
 */
declare function listCurrencies(): Promise<ListCurrenciesResponse & ListCurrenciesResponseNonNullableFields>;
/**
 ...
 * @applicableIdentity APP
 */
declare function convertCurrency(identifiers: ConvertCurrencyIdentifiers, amounts: DecimalValue[]): Promise<ConvertCurrencyResponse & ConvertCurrencyResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function getConversionRate(identifiers: GetConversionRateIdentifiers): Promise<ConversionRateResponse & ConversionRateResponseNonNullableFields>;
...
export { type ConversionRateRequest, type ConversionRateResponse, type ConversionRateResponseNonNullableFields, type ConvertCurrencyIdentifiers, type ConvertCurrencyRequest, type ConvertCurrencyResponse, type ConvertCurrencyResponseNonNullableFields, type Currency, type CurrencyRate, type DecimalValue, type GetConversionRateIdentifiers, type ListCurrenciesRequest, type ListCurrenciesResponse, type ListCurrenciesResponseNonNullableFields, convertCurrency, getConversionRate, listCurrencies };
