...
const PACKAGE_NAME = '@wix/identity_roles-management';
    ...
    function __changeRole({ host }) {
        const metadata = {
            ...
            url: resolveComWixpressRolesManagementApiSiteRolesManagementServiceUrl({
                protoPath: '/roles-management/contributor/change/role',
                data: payload,
                host,
            }),
            data: payload,
...
export function querySiteContributors(payload) {
...
//# sourceMappingURL=identity-v1-contributor-roles-management.http.js.map