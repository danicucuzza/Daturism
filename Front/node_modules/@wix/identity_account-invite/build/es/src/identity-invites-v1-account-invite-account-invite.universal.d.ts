 ...
 */
export declare function createInvite(subjectsAssignments: SubjectInviteAssignments[], options?: CreateInviteOptions): Promise<CreateInviteResponse & CreateInviteResponseNonNullableFields>;
