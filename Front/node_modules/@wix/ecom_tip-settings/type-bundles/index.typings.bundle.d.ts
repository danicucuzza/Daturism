 ...
 */
declare function updateTipSettings(tipSettings: TipSettings): Promise<TipSettings & TipSettingsNonNullableFields>;
/**
 ...
 */
declare function createTipSettings(tipSettings: TipSettings): Promise<TipSettings & TipSettingsNonNullableFields>;
/**
 ...
 * @permissionId WIX_TIPS.TIP_SETTINGS_CREATE
 */
declare function createDefaultTipSettings(tipSettings: TipSettings): Promise<CreateDefaultTipSettingsResponse & CreateDefaultTipSettingsResponseNonNullableFields>;
/**
 ...
 */
declare function deleteTipSettings(tipSettingsId: string | null): Promise<void>;

export { type ActionEvent, type CreateDefaultTipSettingsRequest, type CreateDefaultTipSettingsResponse, type CreateDefaultTipSettingsResponseNonNullableFields, type CreateTipSettingsRequest, type CreateTipSettingsResponse, type CreateTipSettingsResponseNonNullableFields, type CursorPaging, type Cursors, type DeleteTipSettingsRequest, type DeleteTipSettingsResponse, type DomainEvent, type DomainEventBodyOneOf, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, type ExtendedFields, type IdentificationData, type IdentificationDataIdOneOf, type MessageEnvelope, type Paging, type PagingMetadataV2, type Preset, type QueryTipSettingsRequest, type QueryTipSettingsResponse, type QueryTipSettingsResponseNonNullableFields, type QueryV2, type QueryV2PagingMethodOneOf, type RestoreInfo, SortOrder, type Sorting, StaffDistributionMethod, type TipSettings, type TipSettingsIdentifierOneOf, type TipSettingsNonNullableFields, type TipSettingsQueryBuilder, type TipSettingsQueryResult, TipType, type UpdateTipSettingsRequest, type UpdateTipSettingsResponse, type UpdateTipSettingsResponseNonNullableFields, WebhookIdentityType, createDefaultTipSettings, createTipSettings, deleteTipSettings, queryTipSettings, updateTipSettings };
