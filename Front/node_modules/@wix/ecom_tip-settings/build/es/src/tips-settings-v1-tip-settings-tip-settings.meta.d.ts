import * as ambassadorWixTipsSettingsV1TipSettingsTypes from './tips-settings-v1-tip-settings-tip-settings.types';
import * as ambassadorWixTipsSettingsV1TipSettingsUniversalTypes from './tips-settings-v1-tip-settings-tip-settings.universal';
