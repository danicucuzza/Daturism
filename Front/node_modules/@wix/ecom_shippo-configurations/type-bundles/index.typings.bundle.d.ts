 ...
 */
declare function createShippoConfiguration(shippoConfiguration: ShippoConfiguration, options?: CreateShippoConfigurationOptions): Promise<ShippoConfiguration & ShippoConfigurationNonNullableFields>;
 ...
 */
declare function getShippoConfiguration(shippoConfigurationId: string): Promise<ShippoConfiguration & ShippoConfigurationNonNullableFields>;
/**
 ...
 */
declare function updateShippoConfiguration(_id: string | null, shippoConfiguration: UpdateShippoConfiguration): Promise<ShippoConfiguration & ShippoConfigurationNonNullableFields>;
...
export { type ActionEvent, type Address, type AddressLocation, type BaseEventMetadata, CalculationType, type CreateShippoConfigurationOptions, type CreateShippoConfigurationRequest, type CreateShippoConfigurationResponse, type CreateShippoConfigurationResponseNonNullableFields, type CursorPaging, type CursorPagingMetadata, type CursorQuery, type CursorQueryPagingMethodOneOf, type Cursors, type DeleteShippoConfigurationRequest, type DeleteShippoConfigurationResponse, type DomainEvent, type DomainEventBodyOneOf, DomesticService, type DomesticServiceSettings, type Empty, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, type EventMetadata, type ExtendedFields, type GetShippoConfigurationRequest, type GetShippoConfigurationResponse, type GetShippoConfigurationResponseNonNullableFields, type HandlingFee, type IdentificationData, type IdentificationDataIdOneOf, InternationalService, type InternationalServiceSettings, type MessageEnvelope, type PackageDetails, type PackageDimensions, PackageType, type QueryShippoConfigurationsRequest, type QueryShippoConfigurationsResponse, type QueryShippoConfigurationsResponseNonNullableFields, type RestoreInfo, type ServiceSettings, type ShippoConfiguration, type ShippoConfigurationCreatedEnvelope, type ShippoConfigurationDeletedEnvelope, type ShippoConfigurationNonNullableFields, type ShippoConfigurationUpdatedEnvelope, type ShippoConfigurationsQueryBuilder, type ShippoConfigurationsQueryResult, SortOrder, type Sorting, type StreetAddress, type UpdateExtendedFieldsOptions, type UpdateExtendedFieldsRequest, type UpdateExtendedFieldsResponse, type UpdateExtendedFieldsResponseNonNullableFields, type UpdateShippoConfiguration, type UpdateShippoConfigurationRequest, type UpdateShippoConfigurationResponse, type UpdateShippoConfigurationResponseNonNullableFields, WebhookIdentityType, createShippoConfiguration, deleteShippoConfiguration, getShippoConfiguration, onShippoConfigurationCreated, onShippoConfigurationDeleted, onShippoConfigurationUpdated, queryShippoConfigurations, updateExtendedFields, updateShippoConfiguration };
