 ...
 */
declare function chargeMembership(payload: ChargeMembershipEnvelope): ChargeMembershipResponse | Promise<ChargeMembershipResponse>;
/**
 * This method retrieves from your app whether a membership can be voided.
 * @throws TransactionNotFoundWixError
 */
declare function getMembershipVoidability(payload: GetMembershipVoidabilityEnvelope): GetMembershipVoidabilityResponse | Promise<GetMembershipVoidabilityResponse>;
/**
 ...
 */
declare function voidMembershipCharge(payload: VoidMembershipChargeEnvelope): VoidMembershipChargeResponse | Promise<VoidMembershipChargeResponse>;

export { type CatalogReference, type ChargeMembershipEnvelope, type ChargeMembershipRequest, type ChargeMembershipResponse, type Context, type Ended, type GetMembershipVoidabilityEnvelope, type GetMembershipVoidabilityRequest, type GetMembershipVoidabilityResponse, type IdentificationData, type IdentificationDataIdOneOf, IdentityType, type InvalidMembership, InvalidSelectionWixError, type LineItem, type LineItemNotFoundInfo, type ListEligibleMembershipsEnvelope, type ListEligibleMembershipsRequest, type ListEligibleMembershipsResponse, type Membership, type MembershipAlreadyChargedError, MembershipAlreadyChargedWixError, type MembershipCannotBeChargedError, type MembershipCannotBeChargedErrorErrorDataOneOf, MembershipCannotBeChargedType, type MembershipCannotBeUsedForLineItemInfo, type MembershipCannotBeUsedForLineItemsInfo, MembershipCannotBeUsedWixError, MembershipDoesNotApplyToItemWixError, MembershipErrorType, type MembershipInvalidSelectionError, type MembershipInvalidSelectionErrorErrorDataOneOf, type MembershipInvalidSelectionErrors, type MembershipName, type MembershipPaymentCredits, type MembershipsSPIConfig, type NotStartedYet, type OutOfCredits, type SelectedMembership, type SelectedMemberships, type ServiceProperties, TransactionAlreadyVoidedWixError, TransactionCannotBeVoidedWixError, TransactionNotFoundWixError, type VoidMembershipChargeEnvelope, type VoidMembershipChargeRequest, type VoidMembershipChargeResponse, chargeMembership, getMembershipVoidability, listEligibleMemberships, voidMembershipCharge };
