 ...
 */
declare function createLocalDeliveryOption(localDeliveryOption: LocalDeliveryOption): Promise<LocalDeliveryOption & LocalDeliveryOptionNonNullableFields>;
/** @public
 * @documentationMaturity preview
 * @requiredField localDeliveryOptionId
 * @permissionId ECOM.LOCAL_DELIVERY_OPTION_READ
 */
declare function getLocalDeliveryOption(localDeliveryOptionId: string, options?: GetLocalDeliveryOptionOptions): Promise<LocalDeliveryOption & LocalDeliveryOptionNonNullableFields>;
 ...
 */
declare function listLocalDeliveryOptions(externalId: string): Promise<ListLocalDeliveryOptionsResponse & ListLocalDeliveryOptionsResponseNonNullableFields>;
/**
 ...
 */
declare function updateLocalDeliveryOption(_id: string | null, localDeliveryOption: UpdateLocalDeliveryOption): Promise<LocalDeliveryOption & LocalDeliveryOptionNonNullableFields>;
 ...
 * @permissionId ECOM.LOCAL_DELIVERY_OPTION_CREATE
 */
declare function bulkCreateLocalDeliveryOption(localDeliveryOptions: LocalDeliveryOption[]): Promise<BulkCreateLocalDeliveryOptionResponse & BulkCreateLocalDeliveryOptionResponseNonNullableFields>;
/** @public
 * @documentationMaturity preview
 * @requiredField localDeliveryOptions
 * @requiredField localDeliveryOptions.radiusConfig.address
 ...
 * @permissionId ECOM.LOCAL_DELIVERY_OPTION_UPDATE
 */
declare function bulkUpdateLocalDeliveryOption(localDeliveryOptions: LocalDeliveryOption[]): Promise<BulkUpdateLocalDeliveryOptionResponse & BulkUpdateLocalDeliveryOptionResponseNonNullableFields>;
/** @public
 * @documentationMaturity preview
 * @requiredField ids
 * @permissionId ECOM.LOCAL_DELIVERY_OPTION_DELETE
 ...
 * @permissionId ECOM.LOCAL_DELIVERY_OPTION_UPDATE
 */
declare function addDeliveryRegion(deliveryRegionId: string, options?: AddDeliveryRegionOptions): Promise<AddDeliveryRegionResponse & AddDeliveryRegionResponseNonNullableFields>;
 ...
 * @permissionId ECOM.LOCAL_DELIVERY_OPTION_UPDATE
 */
declare function removeDeliveryRegion(deliveryRegionId: string, options?: RemoveDeliveryRegionOptions): Promise<RemoveDeliveryRegionResponse & RemoveDeliveryRegionResponseNonNullableFields>;
