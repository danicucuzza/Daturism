...
export declare function getLocalDeliveryOption(httpClient: HttpClient): GetLocalDeliveryOptionSignature;
...
export declare function listLocalDeliveryOptions(httpClient: HttpClient): ListLocalDeliveryOptionsSignature;
...
export declare function queryLocalDeliveryOptions(httpClient: HttpClient): QueryLocalDeliveryOptionsSignature;
...
export declare function updateLocalDeliveryOption(httpClient: HttpClient): UpdateLocalDeliveryOptionSignature;
...
export declare function deleteLocalDeliveryOption(httpClient: HttpClient): DeleteLocalDeliveryOptionSignature;
...
export declare function bulkCreateLocalDeliveryOption(httpClient: HttpClient): BulkCreateLocalDeliveryOptionSignature;
...
export declare function bulkUpdateLocalDeliveryOption(httpClient: HttpClient): BulkUpdateLocalDeliveryOptionSignature;
...
export declare function bulkDeleteLocalDeliveryOption(httpClient: HttpClient): BulkDeleteLocalDeliveryOptionSignature;
...
export { ActionEvent, AddDeliveryRegionOptions, AddDeliveryRegionRequest, AddDeliveryRegionResponse, AddDeliveryRegionResponseNonNullableFields, AddressLocation, BulkCreateLocalDeliveryOptionRequest, BulkCreateLocalDeliveryOptionResponse, BulkCreateLocalDeliveryOptionResponseNonNullableFields, BulkDeleteLocalDeliveryOptionRequest, BulkDeleteLocalDeliveryOptionResponse, BulkUpdateLocalDeliveryOptionRequest, BulkUpdateLocalDeliveryOptionResponse, BulkUpdateLocalDeliveryOptionResponseNonNullableFields, Condition, ConditionType, ConditionalRates, CreateLocalDeliveryOptionRequest, CreateLocalDeliveryOptionResponse, CreateLocalDeliveryOptionResponseNonNullableFields, CursorPaging, CursorPagingMetadata, Cursors, CustomAreaConfig, DayOfWeek, DaySlot, Days, DeleteLocalDeliveryOptionOptions, DeleteLocalDeliveryOptionRequest, DeleteLocalDeliveryOptionResponse, Destination, DomainEvent, DomainEventBodyOneOf, Empty, EntityCreatedEvent, EntityDeletedEvent, EntityUpdatedEvent, GetLocalDeliveryOptionOptions, GetLocalDeliveryOptionRequest, GetLocalDeliveryOptionResponse, GetLocalDeliveryOptionResponseNonNullableFields, IdentificationData, IdentificationDataIdOneOf, LengthUnit, ListLocalDeliveryOptionsRequest, ListLocalDeliveryOptionsResponse, ListLocalDeliveryOptionsResponseNonNullableFields, LocalDeliveryAddress, LocalDeliveryOption, LocalDeliveryOptionConfigOneOf, LocalDeliveryOptionError, LocalDeliveryOptionNonNullableFields, LocalDeliveryOptionsQueryBuilder, LocalDeliveryOptionsQueryResult, LogicalOperator, MessageEnvelope, Paging, QueryLocalDeliveryOptionsRequest, QueryLocalDeliveryOptionsResponse, QueryLocalDeliveryOptionsResponseNonNullableFields, QueryV2, QueryV2PagingMethodOneOf, RadiusConfig, RemoveDeliveryRegionOptions, RemoveDeliveryRegionRequest, RemoveDeliveryRegionResponse, RemoveDeliveryRegionResponseNonNullableFields, RestoreInfo, ScheduledDelivery, SortOrder, Sorting, TimeOfDay, TimePoint, TimeSlot, TimeWindow, UpdateLocalDeliveryOption, UpdateLocalDeliveryOptionRequest, UpdateLocalDeliveryOptionResponse, UpdateLocalDeliveryOptionResponseNonNullableFields, WebhookIdentityType, ZipCodeConfig, } from './ecom-v1-local-delivery-option-local-delivery-options.universal';
