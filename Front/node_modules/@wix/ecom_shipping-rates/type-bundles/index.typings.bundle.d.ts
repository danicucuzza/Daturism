 ...
 * @throws MissingPostalCodeWixError
 * @throws InvalidPostalCodeWixError
 * @throws InvalidAddressWixError
 * @throws GenericShippingRatesWixError
 */
declare function getShippingRates(payload: GetShippingRatesEnvelope): GetShippingRatesResponse | Promise<GetShippingRatesResponse>;

export { type AdditionalCharge, type Address, type AddressLocation, type AddressStreetOneOf, type ApplicationError, type CatalogReference, ChargeType, type Column, type Context, type DashboardTable, type DeliveryLogistics, type DeliveryPreferences, type DeliveryTimeSlot, type ExternalReference, type FieldViolation, type FullAddressContactDetails, type GenericShippingRatesError, GenericShippingRatesWixError, type GetDashboardTablesRequest, type GetDashboardTablesResponse, type GetShippingRatesEnvelope, type GetShippingRatesRequest, type GetShippingRatesResponse, type IdentificationData, type IdentificationDataIdOneOf, IdentityType, type InvalidAddressError, InvalidAddressWixError, type InvalidPostalCodeError, InvalidPostalCodeWixError, type MissingPostalCodeError, MissingPostalCodeWixError, type PartialOption, type PhysicalProperties, type PickupDetails, PickupMethod, type ProductItem, type RegionDashboardTables, type Row, RuleType, type ShippingOption, type ShippingPrice, type ShippingRatesConfig, type StandardDetails, type StreetAddress, type Subdivision, SubdivisionType, type VatId, VatType, WeightUnit, getShippingRates };
