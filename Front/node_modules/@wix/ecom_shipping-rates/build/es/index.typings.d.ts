import { GetShippingRatesResponse } from './src/service-plugins-types';
import { GetShippingRatesEnvelope } from './src/interfaces-ecom-v1-shipping-rates-provider.public';
export * from './src/service-plugins-error-classes';
export * from './src/service-plugins-types';
export { GetShippingRatesEnvelope };
/**
 ...
 */
export declare function getShippingRates(payload: GetShippingRatesEnvelope): GetShippingRatesResponse | Promise<GetShippingRatesResponse>;
