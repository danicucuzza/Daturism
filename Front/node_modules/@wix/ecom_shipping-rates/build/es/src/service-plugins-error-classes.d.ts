import { MissingPostalCodeError, InvalidPostalCodeError, InvalidAddressError, GenericShippingRatesError } from './service-plugins-types';
/**
 ...
 */
export declare class MissingPostalCodeWixError extends Error {
    /** @hidden */
    httpCode: number;
    /** @hidden */
    statusCode: string;
...
This error may block the site visitor from proceeding to checkout, so throw it only if there is no other way to proceed.
 */
export declare class InvalidPostalCodeWixError extends Error {
    /** @hidden */
    httpCode: number;
    /** @hidden */
    statusCode: string;
 ...
 */
export declare class InvalidAddressWixError extends Error {
    /** @hidden */
    httpCode: number;
    /** @hidden */
    statusCode: string;
...
This error may block the site visitor from proceeding to checkout, so throw it only if there is no other way to proceed.
 */
export declare class GenericShippingRatesWixError extends Error {
    /** @hidden */
    httpCode: number;
    /** @hidden */
    statusCode: string;
