import { GetRecommendationsResponse } from './src/service-plugins-types';
import { GetRecommendationsEnvelope } from './src/interfaces-ecom-v1-recommendations-provider.public';
export * from './src/service-plugins-error-classes';
export * from './src/service-plugins-types';
export { GetRecommendationsEnvelope };
/**
 ...
 */
export declare function getRecommendations(payload: GetRecommendationsEnvelope): GetRecommendationsResponse | Promise<GetRecommendationsResponse>;
