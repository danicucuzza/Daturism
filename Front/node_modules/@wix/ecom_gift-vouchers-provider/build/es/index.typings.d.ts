import { GetBalanceResponse, RedeemResponse, VoidResponse } from './src/service-plugins-types';
import { GetBalanceEnvelope, RedeemEnvelope, _voidEnvelope } from './src/interfaces-ecom-v1-gift-card-provider-entity.public';
export * from './src/service-plugins-error-classes';
export * from './src/service-plugins-types';
export { GetBalanceEnvelope, RedeemEnvelope, _voidEnvelope };
/**
 ...
 */
export declare function getBalance(payload: GetBalanceEnvelope): GetBalanceResponse | Promise<GetBalanceResponse>;
/**
 ...
 */
export declare function redeem(payload: RedeemEnvelope): RedeemResponse | Promise<RedeemResponse>;
/**
 ...
 */
export declare function _void(payload: _voidEnvelope): VoidResponse | Promise<VoidResponse>;
