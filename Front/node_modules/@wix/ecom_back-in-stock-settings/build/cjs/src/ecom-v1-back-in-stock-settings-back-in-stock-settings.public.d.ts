...
import { GetSettingsResponse, GetSettingsResponseNonNullableFields, StartCollectingRequestsResponse, StartCollectingRequestsResponseNonNullableFields, StopCollectingRequestsResponse, StopCollectingRequestsResponseNonNullableFields } from './ecom-v1-back-in-stock-settings-back-in-stock-settings.universal';
export declare const __metadata: {
    PACKAGE_NAME: string;
};
export declare function startCollectingRequests(httpClient: HttpClient): StartCollectingRequestsSignature;
...
export declare function stopCollectingRequests(httpClient: HttpClient): StopCollectingRequestsSignature;
...
export declare function getSettings(httpClient: HttpClient): GetSettingsSignature;
...
export { BackInStockCollectionState, BackInStockSettings, GetSettingsRequest, GetSettingsResponse, GetSettingsResponseNonNullableFields, StartCollectingRequestsRequest, StartCollectingRequestsResponse, StartCollectingRequestsResponseNonNullableFields, StopCollectingRequestsRequest, StopCollectingRequestsResponse, StopCollectingRequestsResponseNonNullableFields, } from './ecom-v1-back-in-stock-settings-back-in-stock-settings.universal';
