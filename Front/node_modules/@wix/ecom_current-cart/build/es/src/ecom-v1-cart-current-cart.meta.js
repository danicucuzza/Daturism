...
export function addToCurrentCart() {
    const payload = {};
...
export function createCheckoutFromCurrentCart() {
    const payload = {};
...
export function updateCurrentCartLineItemQuantity() {
    const payload = {};
...
export function estimateCurrentCartTotals() {
    const payload = {};
