...
declare function getCurrentCart(): __PublicMethodMetaInfo<'GET', {}, GetCurrentCartRequest, GetCurrentCartRequest$1, GetCurrentCartResponse & GetCurrentCartResponseNonNullableFields, GetCurrentCartResponse$1 & GetCurrentCartResponseNonNullableFields$1>;
declare function updateCurrentCart(): __PublicMethodMetaInfo<'PATCH', {}, UpdateCartRequest, UpdateCartRequest$1, UpdateCartResponse & UpdateCartResponseNonNullableFields, UpdateCartResponse$1 & UpdateCartResponseNonNullableFields$1>;
declare function addToCurrentCart(): __PublicMethodMetaInfo<'POST', {}, AddToCurrentCartRequest, AddToCurrentCartRequest$1, AddToCartResponse & AddToCartResponseNonNullableFields, AddToCartResponse$1 & AddToCartResponseNonNullableFields$1>;
declare function removeLineItemsFromCurrentCart(): __PublicMethodMetaInfo<'POST', {}, RemoveLineItemsFromCurrentCartRequest, RemoveLineItemsFromCurrentCartRequest$1, RemoveLineItemsResponse & RemoveLineItemsResponseNonNullableFields, RemoveLineItemsResponse$1 & RemoveLineItemsResponseNonNullableFields$1>;
declare function createCheckoutFromCurrentCart(): __PublicMethodMetaInfo<'POST', {}, CreateCheckoutFromCurrentCartRequest, CreateCheckoutFromCurrentCartRequest$1, CreateCheckoutResponse & CreateCheckoutResponseNonNullableFields, CreateCheckoutResponse$1 & CreateCheckoutResponseNonNullableFields$1>;
declare function removeCouponFromCurrentCart(): __PublicMethodMetaInfo<'POST', {}, RemoveCouponFromCurrentCartRequest, RemoveCouponFromCurrentCartRequest$1, RemoveCouponResponse & RemoveCouponResponseNonNullableFields, RemoveCouponResponse$1 & RemoveCouponResponseNonNullableFields$1>;
declare function updateCurrentCartLineItemQuantity(): __PublicMethodMetaInfo<'POST', {}, UpdateCurrentCartLineItemQuantityRequest, UpdateCurrentCartLineItemQuantityRequest$1, UpdateLineItemsQuantityResponse & UpdateLineItemsQuantityResponseNonNullableFields, UpdateLineItemsQuantityResponse$1 & UpdateLineItemsQuantityResponseNonNullableFields$1>;
declare function estimateCurrentCartTotals(): __PublicMethodMetaInfo<'POST', {}, EstimateCurrentCartTotalsRequest, EstimateCurrentCartTotalsRequest$1, EstimateTotalsResponse & EstimateTotalsResponseNonNullableFields, EstimateTotalsResponse$1 & EstimateTotalsResponseNonNullableFields$1>;
declare function deleteCurrentCart(): __PublicMethodMetaInfo<'DELETE', {}, DeleteCurrentCartRequest, DeleteCurrentCartRequest$1, DeleteCartResponse, DeleteCartResponse$1>;
