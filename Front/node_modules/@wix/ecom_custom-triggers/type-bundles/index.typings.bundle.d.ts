 ...
 */
declare function listTriggers(payload: ListTriggersEnvelope): ListTriggersResponse | Promise<ListTriggersResponse>;
/**
 ...
 */
declare function getEligibleTriggers(payload: GetEligibleTriggersEnvelope): GetEligibleTriggersResponse | Promise<GetEligibleTriggersResponse>;

export { type CatalogReference, type Context, type CustomTrigger, type CustomTriggerConfig, type EligibleTrigger, type GetEligibleTriggersEnvelope, type GetEligibleTriggersRequest, type GetEligibleTriggersResponse, type IdentificationData, type IdentificationDataIdOneOf, IdentityType, type LineItem, type ListTriggersEnvelope, type ListTriggersRequest, type ListTriggersResponse, type ListTriggersResponseCustomTrigger, type TriggerToFilterBy, getEligibleTriggers, listTriggers };
