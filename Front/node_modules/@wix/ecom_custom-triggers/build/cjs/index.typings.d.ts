import { ListTriggersResponse, GetEligibleTriggersResponse } from './src/service-plugins-types';
import { ListTriggersEnvelope, GetEligibleTriggersEnvelope } from './src/interfaces-ecommerce-v1-custom-trigger.public';
export * from './src/service-plugins-types';
export { ListTriggersEnvelope, GetEligibleTriggersEnvelope };
/**
 ...
 */
export declare function listTriggers(payload: ListTriggersEnvelope): ListTriggersResponse | Promise<ListTriggersResponse>;
/**
 ...
 */
export declare function getEligibleTriggers(payload: GetEligibleTriggersEnvelope): GetEligibleTriggersResponse | Promise<GetEligibleTriggersResponse>;
