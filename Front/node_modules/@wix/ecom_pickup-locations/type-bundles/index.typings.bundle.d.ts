 ...
 */
declare function createPickupLocation(pickupLocation: PickupLocation): Promise<PickupLocation & PickupLocationNonNullableFields>;
/**
 ...
 */
declare function getPickupLocation(pickupLocationId: string): Promise<PickupLocation & PickupLocationNonNullableFields>;
/**
 ...
 */
declare function updatePickupLocation(_id: string | null, pickupLocation: UpdatePickupLocation): Promise<PickupLocation & PickupLocationNonNullableFields>;
 ...
 * @permissionId ECOM.PICKUP_LOCATION_UPDATE
 */
declare function addDeliveryRegion(pickupLocationId: string, deliveryRegionId: string, options: AddDeliveryRegionOptions): Promise<AddDeliveryRegionResponse & AddDeliveryRegionResponseNonNullableFields>;
 ...
 * @permissionId ECOM.PICKUP_LOCATION_UPDATE
 */
declare function removeDeliveryRegion(pickupLocationId: string, deliveryRegionId: string, options: RemoveDeliveryRegionOptions): Promise<RemoveDeliveryRegionResponse & RemoveDeliveryRegionResponseNonNullableFields>;
 ...
 * @permissionId ECOM.PICKUP_LOCATION_CREATE
 */
declare function bulkCreatePickupLocation(pickupLocations: PickupLocation[]): Promise<BulkCreatePickupLocationResponse & BulkCreatePickupLocationResponseNonNullableFields>;
/**
 * Update a PickupLocation
 * @public
 * @documentationMaturity preview
 ...
 * @permissionId ECOM.PICKUP_LOCATION_UPDATE
 */
declare function bulkUpdatePickupLocation(pickupLocations: PickupLocation[]): Promise<BulkUpdatePickupLocationResponse & BulkUpdatePickupLocationResponseNonNullableFields>;
/**
 * Delete a PickupLocation
 * @public
 * @documentationMaturity preview
 ...
 * @permissionId ECOM.PICKUP_LOCATION_DELETE
 */
declare function bulkDeletePickupLocation(pickupLocationIds: string[]): Promise<BulkDeletePickupLocationResponse & BulkDeletePickupLocationResponseNonNullableFields>;

export { type ActionEvent, type AddDeliveryRegionOptions, type AddDeliveryRegionRequest, type AddDeliveryRegionResponse, type AddDeliveryRegionResponseNonNullableFields, type Address, type AddressStreetOneOf, type ApplicationError, type BulkCreatePickupLocationRequest, type BulkCreatePickupLocationResponse, type BulkCreatePickupLocationResponseNonNullableFields, type BulkDeletePickupLocationRequest, type BulkDeletePickupLocationResponse, type BulkDeletePickupLocationResponseNonNullableFields, type BulkUpdatePickupLocationRequest, type BulkUpdatePickupLocationResponse, type BulkUpdatePickupLocationResponseNonNullableFields, type Condition, ConditionType, type ConditionalRates, type CreatePickupLocationRequest, type CreatePickupLocationResponse, type CreatePickupLocationResponseNonNullableFields, type CursorPaging, type CursorPagingMetadata, type Cursors, type DeletePickupLocationRequest, type DeletePickupLocationResponse, type DiffmatokyPayload, type DomainEvent, type DomainEventBodyOneOf, type Empty, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, type ErrorInformation, type GetPickupLocationRequest, type GetPickupLocationResponse, type GetPickupLocationResponseNonNullableFields, type IdentificationData, type IdentificationDataIdOneOf, LogicalOperator, type MessageEnvelope, type Paging, type PickupLocation, type PickupLocationError, type PickupLocationNonNullableFields, type PickupLocationsQueryBuilder, type PickupLocationsQueryResult, type QueryPickupLocationRequest, type QueryPickupLocationResponse, type QueryPickupLocationResponseNonNullableFields, type QueryV2, type QueryV2PagingMethodOneOf, type RemoveDeliveryRegionOptions, type RemoveDeliveryRegionRequest, type RemoveDeliveryRegionResponse, type RemoveDeliveryRegionResponseNonNullableFields, type RestoreInfo, SortOrder, type Sorting, type StreetAddress, type UpdatePickupLocation, type UpdatePickupLocationRequest, type UpdatePickupLocationResponse, type UpdatePickupLocationResponseNonNullableFields, WebhookIdentityType, addDeliveryRegion, bulkCreatePickupLocation, bulkDeletePickupLocation, bulkUpdatePickupLocation, createPickupLocation, deletePickupLocation, getPickupLocation, queryPickupLocation, removeDeliveryRegion, updatePickupLocation };
