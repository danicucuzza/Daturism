 ...
 * @documentationMaturity preview
 */
export declare function loginWithIdpConnectionCallback(options?: LoginWithIdpConnectionCallbackOptions): Promise<RawHttpResponse & RawHttpResponseNonNullableFields>;
export interface LoginWithIdpConnectionCallbackOptions {
    body?: Uint8Array;
    pathParams?: PathParametersEntry[];
    queryParams?: QueryParametersEntry[];
    headers?: HeadersEntry[];
