...
exports.logout = exports.signOn = exports.loginWithIdpConnectionTokenParams = exports.loginCallback = exports.loginWithIdpConnectionCallback = exports.loginWithIdpConnection = exports.changePassword = exports.loginV2 = exports.registerV2 = exports.TenantType = exports.Status = exports.FactorType = exports.Reason = exports.StatusName = exports.StateType = exports.AddressTag = exports.PhoneTag = exports.EmailTag = exports.PrivacyStatus = void 0;
...
(function (StateType) {
    ...
    StateType["REQUIRE_MFA"] = "REQUIRE_MFA";
 ...
 * @documentationMaturity preview
 */
async function loginWithIdpConnectionCallback(options) {
    // @ts-ignore
    const { httpClient, sideEffects } = arguments[1];
    const payload = (0, rename_all_nested_keys_1.renameKeysFromSDKRequestToRESTRequest)({
        body: options?.body,
    ...
    const reqOpts = ambassadorWixIamAuthenticationV1Authentication.loginWithIdpConnectionCallback(payload);
    sideEffects?.onSiteCall?.();
    try {
        const result = await httpClient.request(reqOpts);
        sideEffects?.onSuccess?.(result);
