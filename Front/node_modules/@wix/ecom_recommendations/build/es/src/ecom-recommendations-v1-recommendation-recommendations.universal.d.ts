 ...
 */
export declare function listAvailableAlgorithms(): Promise<ListAvailableAlgorithmsResponse & ListAvailableAlgorithmsResponseNonNullableFields>;
/**
 ...
 * @applicableIdentity VISITOR
 */
export declare function getRecommendation(algorithms: Algorithm[], options?: GetRecommendationOptions): Promise<GetRecommendationResponse & GetRecommendationResponseNonNullableFields>;
