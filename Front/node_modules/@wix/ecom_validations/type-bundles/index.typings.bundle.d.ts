 ...
 */
declare function getValidationViolations(payload: GetValidationViolationsEnvelope): GetValidationViolationsResponse | Promise<GetValidationViolationsResponse>;

export { type Address, type AddressLocation, type AddressWithContact, type AppliedDiscount, type AppliedDiscountDiscountSourceOneOf, type BuyerDetails, type CatalogReference, CheckoutStage, type Context, type Coupon, type CustomField, type CustomFields, type Description, type DiscountRule, type DiscountRuleName, DiscountType, type ExtendedFields, type ExternalReference, type FreeTrialPeriod, type FullAddressContactDetails, type GetValidationViolationsEnvelope, type GetValidationViolationsRequest, type GetValidationViolationsResponse, type GiftCard, type IdentificationData, type IdentificationDataIdOneOf, IdentityType, type ItemTaxFullDetails, type ItemType, ItemTypeItemType, type ItemTypeItemTypeDataOneOf, JurisdictionType, type LineItem, type LineItemPricesData, type MerchantDiscount, type MultiCurrencyPrice, NameInLineItem, NameInOther, type Other, type PhysicalProperties, type PriceSummary, type ProductName, type SelectedCarrierServiceOption, type SelectedCarrierServiceOptionPrices, Severity, type ShippingInfo, Source, type SourceInfo, type Stage, type StageStagesOneOf, type StreetAddress, SubscriptionFrequency, type SubscriptionOptionInfo, type SubscriptionSettings, SuggestedFix, type Target, type TargetLineItem, type TargetTargetTypeOneOf, type TaxBreakdown, type Title, type ValidationInfo, type ValidationsSPIConfig, type VatId, VatType, type Violation, WeightUnit, getValidationViolations };
