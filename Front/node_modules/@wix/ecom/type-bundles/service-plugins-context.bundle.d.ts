...
type context$1_DescriptionLine = DescriptionLine;
type context$1_DescriptionLineDescriptionLineValueOneOf = DescriptionLineDescriptionLineValueOneOf;
type context$1_DescriptionLineName = DescriptionLineName;
...
type context$1_LineItemExchangeData = LineItemExchangeData;
type context$1_LineItemPriceChange = LineItemPriceChange;
type context$1_LineItemQuantityChange = LineItemQuantityChange;
type context$1_LineItemQuantityChangeType = LineItemQuantityChangeType;
...
type context$1_OrderChange = OrderChange;
type context$1_OrderChangeValueOneOf = OrderChangeValueOneOf;
type context$1_OrderCreatedFromExchange = OrderCreatedFromExchange;
type context$1_OrderLineItem = OrderLineItem;
type context$1_OrderRefunded = OrderRefunded;
...
type context_GiftCard = GiftCard;
...
type context_ItemTaxFullDetails = ItemTaxFullDetails;
type context_ItemType = ItemType;
type context_ItemTypeItemType = ItemTypeItemType;
declare const context_ItemTypeItemType: typeof ItemTypeItemType;
type context_ItemTypeItemTypeDataOneOf = ItemTypeItemTypeDataOneOf;
type context_JurisdictionType = JurisdictionType;
declare const context_JurisdictionType: typeof JurisdictionType;
type context_LineItem = LineItem;
type context_LineItemPricesData = LineItemPricesData;
type context_MerchantDiscount = MerchantDiscount;
type context_MultiCurrencyPrice = MultiCurrencyPrice;
type context_NameInLineItem = NameInLineItem;
declare const context_NameInLineItem: typeof NameInLineItem;
type context_NameInOther = NameInOther;
declare const context_NameInOther: typeof NameInOther;
type context_Other = Other;
...
declare const context_Severity: typeof Severity;
type context_ShippingInfo = ShippingInfo;
...
type context_SubscriptionOptionInfo = SubscriptionOptionInfo;
type context_SubscriptionSettings = SubscriptionSettings;
type context_SuggestedFix = SuggestedFix;
declare const context_SuggestedFix: typeof SuggestedFix;
type context_Target = Target;
type context_TargetLineItem = TargetLineItem;
type context_TargetTargetTypeOneOf = TargetTargetTypeOneOf;
type context_TaxBreakdown = TaxBreakdown;
type context_Title = Title;
type context_ValidationInfo = ValidationInfo;
type context_ValidationsSPIConfig = ValidationsSPIConfig;
type context_VatId = VatId;
type context_VatType = VatType;
declare const context_VatType: typeof VatType;
