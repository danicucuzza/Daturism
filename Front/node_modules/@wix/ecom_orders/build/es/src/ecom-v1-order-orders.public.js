...
export const onOrderPaymentStatusUpdated = EventDefinition('wix.ecom.v1.order_payment_status_updated', true, (event) => renameKeysFromRESTResponseToSDKResponse(transformPaths(event, [
    {
