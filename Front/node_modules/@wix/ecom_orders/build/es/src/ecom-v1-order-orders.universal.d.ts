...
export interface Payment extends PaymentPaymentDetailsOneOf {
 ...
 */
export declare function onOrderPaymentStatusUpdated(handler: (event: OrderPaymentStatusUpdatedEnvelope) => void | Promise<void>): void;
 ...
 */
export declare function createOrder(order: Order): Promise<Order & OrderNonNullableFields>;
/**
 * Updates an order.
 *
 *
