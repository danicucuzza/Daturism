...
import { BulkUpdateOrderTagsOptions, BulkUpdateOrderTagsResponse, BulkUpdateOrderTagsResponseNonNullableFields, BulkUpdateOrdersOptions, BulkUpdateOrdersResponse, BulkUpdateOrdersResponseNonNullableFields, CancelOrderOptions, CancelOrderResponse, CancelOrderResponseNonNullableFields, CaptureAuthorizedPaymentsResponse, CaptureAuthorizedPaymentsResponseNonNullableFields, GetPaymentCollectabilityStatusResponse, GetPaymentCollectabilityStatusResponseNonNullableFields, MaskedOrder, Order, OrderApprovedEnvelope, OrderCanceledEnvelope, OrderCreatedEnvelope, OrderNonNullableFields, OrderPaymentStatusUpdatedEnvelope, OrderUpdatedEnvelope, PaymentCapture, PreparePaymentCollectionOptions, PreparePaymentCollectionResponse, PreparePaymentCollectionResponseNonNullableFields, Price, SearchOrdersOptions, SearchOrdersResponse, SearchOrdersResponseNonNullableFields, UpdateOrder, VoidAuthorizedPaymentsResponse, VoidAuthorizedPaymentsResponseNonNullableFields } from './ecom-v1-order-orders.universal';
...
export declare const onOrderPaymentStatusUpdated: EventDefinition<OrderPaymentStatusUpdatedEnvelope, "wix.ecom.v1.order_payment_status_updated">;
