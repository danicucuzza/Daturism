 ...
 */
declare function preparePaymentCollection(ecomOrderId: string, amount: Price, options?: PreparePaymentCollectionOptions): Promise<PreparePaymentCollectionResponse & PreparePaymentCollectionResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function getPaymentCollectabilityStatus(ecomOrderId: string): Promise<GetPaymentCollectabilityStatusResponse & GetPaymentCollectabilityStatusResponseNonNullableFields>;
/**
 ...
 * @applicableIdentity APP
 */
declare function voidAuthorizedPayments(ecomOrderId: string, paymentIds: string[]): Promise<VoidAuthorizedPaymentsResponse & VoidAuthorizedPaymentsResponseNonNullableFields>;
/**
 ...
 * @applicableIdentity APP
 */
declare function captureAuthorizedPayments(ecomOrderId: string, payments: PaymentCapture[]): Promise<CaptureAuthorizedPaymentsResponse & CaptureAuthorizedPaymentsResponseNonNullableFields>;
/**
 * Retrieves an order.
 *
 *
 ...
 */
declare function getOrder(_id: string): Promise<Order & OrderNonNullableFields>;
/**
 ...
 * @applicableIdentity APP
 */
declare function searchOrders(options?: SearchOrdersOptions): Promise<SearchOrdersResponse & SearchOrdersResponseNonNullableFields>;
 ...
 */
declare function createOrder(order: Order): Promise<Order & OrderNonNullableFields>;
/**
 * Updates an order.
 *
 *
 ...
 * @returns Newly created order.
 */
declare function updateOrder(_id: string | null, order: UpdateOrder): Promise<Order & OrderNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function bulkUpdateOrders(orders: MaskedOrder[], options?: BulkUpdateOrdersOptions): Promise<BulkUpdateOrdersResponse & BulkUpdateOrdersResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function cancelOrder(_id: string, options?: CancelOrderOptions): Promise<CancelOrderResponse & CancelOrderResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function bulkUpdateOrderTags(orderIds: string[], options?: BulkUpdateOrderTagsOptions): Promise<BulkUpdateOrderTagsResponse & BulkUpdateOrderTagsResponseNonNullableFields>;
...
export { type ActionEvent, ActionType, type Activity, type ActivityContentOneOf, ActivityType, type AddActivitiesRequest, type AddActivitiesResponse, type AddActivityRequest, type AddActivityResponse, type AddInternalActivityRequest, type AddInternalActivityResponse, type AdditionalFee, type AdditionalFeeDelta, type AdditionalFeeDeltaDeltaOneOf, type AdditionalFeeRefund, type Address, type AddressDescription, type AddressLocation, type AddressWithContact, type AggregateOrdersRequest, type AggregateOrdersResponse, type AggregatedRefundSummary, type App, type ApplicationError, type AppliedDiscount, type AppliedDiscountDelta, type AppliedDiscountDeltaDeltaOneOf, type AppliedDiscountDiscountSourceOneOf, type ArchiveOrderRequest, type ArchiveOrderResponse, AttributionSource, type AuthorizationActionFailureDetails, type AuthorizationCapture, AuthorizationCaptureStatus, type AuthorizationDetails, type AuthorizationVoid, AuthorizationVoidStatus, type AuthorizedPaymentCaptured, type AuthorizedPaymentCreated, type AuthorizedPaymentVoided, type Balance, type BalanceSummary, type BaseEventMetadata, type BatchOfTriggerReindexOrderRequest, type BigDecimalWrapper, type BulkActionMetadata, type BulkArchiveOrdersByFilterRequest, type BulkArchiveOrdersByFilterResponse, type BulkArchiveOrdersRequest, type BulkArchiveOrdersResponse, type BulkMarkAsFulfilledByFilterRequest, type BulkMarkAsFulfilledByFilterResponse, type BulkMarkAsFulfilledRequest, type BulkMarkAsFulfilledResponse, type BulkMarkAsUnfulfilledByFilterRequest, type BulkMarkAsUnfulfilledByFilterResponse, type BulkMarkAsUnfulfilledRequest, type BulkMarkAsUnfulfilledResponse, type BulkMarkOrdersAsPaidRequest, type BulkMarkOrdersAsPaidResponse, type BulkOrderResult, type BulkSendBuyerPickupConfirmationEmailsRequest, type BulkSendBuyerPickupConfirmationEmailsResponse, type BulkSendBuyerShippingConfirmationEmailsRequest, type BulkSendBuyerShippingConfirmationEmailsResponse, type BulkUnArchiveOrdersByFilterRequest, type BulkUnArchiveOrdersByFilterResponse, type BulkUnArchiveOrdersRequest, type BulkUnArchiveOrdersResponse, type BulkUpdateOrderTagsOptions, type BulkUpdateOrderTagsRequest, type BulkUpdateOrderTagsResponse, type BulkUpdateOrderTagsResponseNonNullableFields, type BulkUpdateOrderTagsResult, type BulkUpdateOrdersOptions, type BulkUpdateOrdersRequest, type BulkUpdateOrdersResponse, type BulkUpdateOrdersResponseNonNullableFields, type BuyerInfo, type BuyerInfoIdOneOf, type BuyerInfoUpdate, type CalculateRefundItemRequest, type CalculateRefundItemResponse, type CalculateRefundRequest, type CalculateRefundResponse, type CalculatedTax, type CalculatedTaxes, type Cancel, type CancelOrderOptions, type CancelOrderRequest, type CancelOrderResponse, type CancelOrderResponseNonNullableFields, type CaptureAuthorizedPaymentsRequest, type CaptureAuthorizedPaymentsResponse, type CaptureAuthorizedPaymentsResponseNonNullableFields, type CatalogReference, type ChannelInfo, ChannelType, type ChargeMembershipsRequest, type ChargeMembershipsResponse, type ChargeSavedPaymentMethodRequest, type ChargeSavedPaymentMethodResponse, type ChargedBy, type Color, type CommitDeltasRequest, type CommitDeltasResponse, type CommittedDiffs, type CommittedDiffsShippingUpdateInfoOneOf, type CommonAddress, type CommonAddressStreetOneOf, type Company, type Complete, type ContinueSideEffectsFlowInLegacyData, type Coupon, type CreateOrderRequest, type CreateOrderResponse, type CreateOrderResponseNonNullableFields, type CreatePaymentGatewayOrderRequest, type CreatePaymentGatewayOrderResponse, type CreatedBy, type CreatedByStringOneOf, type CreditCardDetails, type CreditCardPaymentMethodDetails, type CursorPaging, type CursorPagingMetadata, type CursorSearch, type CursorSearchPagingMethodOneOf, type Cursors, type CustomActivity, type CustomField, CustomFieldGroup, type CustomFieldValue, type Customer, type DecrementData, type DecrementItemsQuantityRequest, type DecrementItemsQuantityResponse, type DelayedCaptureSettings, type DeleteActivityRequest, type DeleteActivityResponse, type DeleteByFilterOperation, type DeleteByIdsOperation, type DeliveryLogistics, type DeliveryLogisticsAddressOneOf, type DeliveryTimeSlot, DeltaPaymentOptionType, type Deposit, DepositType, type DescriptionLine, type DescriptionLineDescriptionLineValueOneOf, type DescriptionLineName, DescriptionLineType, type DescriptionLineValueOneOf, type DiffmatokyPayload, type DigitalFile, type Discount, type DiscountOneDiscountTypeOneOf, DiscountReason, type DiscountRule, type DiscountRuleName, DiscountType, type DomainEvent, type DomainEventBodyOneOf, type DownloadLinkSent, type DraftOrderChangesApplied, type DraftOrderCommitSettings, type DraftOrderDiffs, type DraftOrderDiffsBillingUpdateInfoOneOf, type DraftOrderDiffsBuyerUpdateInfoOneOf, type DraftOrderDiffsRecipientUpdateInfoOneOf, type DraftOrderDiffsShippingUpdateInfoOneOf, type Duration, DurationUnit, type Email, type EmailEdited, type Empty, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, type ErrorInformation, type EventMetadata, type ExtendedFields, type ExternalUriMapping, type FulfillerEmailSent, FulfillmentStatus, type FulfillmentStatusUpdated, type FulfillmentStatusesAggregate, type FullAddressContactDetails, type GetMetasiteDataRequest, type GetMetasiteDataResponse, type GetOrderForMetasiteRequest, type GetOrderForMetasiteResponse, type GetOrderRequest, type GetOrderResponse, type GetOrderResponseNonNullableFields, type GetPaymentCollectabilityStatusRequest, type GetPaymentCollectabilityStatusResponse, type GetPaymentCollectabilityStatusResponseNonNullableFields, type GetRefundabilityStatusRequest, type GetRefundabilityStatusResponse, type GetShipmentsRequest, type GetShipmentsResponse, type GiftCardPaymentDetails, type GiftCardPaymentRefund, type HtmlApplication, type IdAndVersion, type IdentificationData, type IdentificationDataIdOneOf, type IndexingMessage, type InternalActivity, type InternalActivityContentOneOf, type InternalDocument, type InternalDocumentUpdateByFilterOperation, type InternalDocumentUpdateOperation, type InternalQueryOrdersRequest, type InternalQueryOrdersResponse, type InternalUpdateExistingOperation, InventoryAction, type InventoryUpdateDetails, type InvoiceAdded, type InvoiceDates, type InvoiceDynamicPriceTotals, type InvoiceFields, type InvoiceSent, type InvoiceSentEvent, InvoiceStatus, type InvoicesPayment, type ItemChangedDetails, type ItemMetadata, type ItemTaxFullDetails, type ItemType, ItemTypeItemType, type ItemTypeItemTypeDataOneOf, type ItemizedFee, JurisdictionType, type LineItem, type LineItemAmount, type LineItemChanges, type LineItemDelta, type LineItemDeltaDeltaOneOf, type LineItemDiscount, type LineItemExchangeData, type LineItemMetaData, type LineItemPriceChange, type LineItemQuantityChange, LineItemQuantityChangeType, type LineItemRefund, type LineItemTax, type LineItemTaxBreakdown, type LineItemTaxInfo, type LineItemUpdate, type LineItems, type ListOrderTransactionsForMetasiteRequest, type ListOrderTransactionsForMetasiteResponse, type Locale, type LocationAndQuantity, type ManagedAdditionalFee, type ManagedDiscount, type ManagedLineItem, ManuallyRefundableReason, type MarkAsFulfilledRequest, type MarkAsFulfilledResponse, type MarkAsUnfulfilledRequest, type MarkAsUnfulfilledResponse, type MarkOrderAsPaidRequest, type MarkOrderAsPaidResponse, type MarkOrderAsSeenByHumanRequest, type MarkOrderAsSeenByHumanResponse, type MaskedOrder, type MaskedOrderLineItem, type MembershipChargeItem, type MembershipName, type MembershipPaymentDetails, type MembershipPaymentRefund, MembershipPaymentStatus, type MerchantComment, type MerchantDiscount, type MerchantDiscountMerchantDiscountReasonOneOf, type MessageEnvelope, type MetaData, type MetaSite, type MetaTag, Namespace, type NewExchangeOrderCreated, NonRefundableReason, type Order, OrderApprovalStrategy, type OrderApproved, type OrderApprovedEnvelope, type OrderCanceled, type OrderCanceledEnvelope, type OrderCanceledEventOrderCanceled, type OrderChange, type OrderChangeValueOneOf, type OrderCreateNotifications, type OrderCreatedEnvelope, type OrderCreatedFromExchange, type OrderCreationSettings, type OrderDeltasCommitted, type OrderFulfilled, type OrderItemsRestocked, type OrderLineItem, type OrderLineItemChangedDetails, type OrderNonNullableFields, type OrderNotFulfilled, type OrderPaid, type OrderPartiallyPaid, type OrderPaymentStatusUpdatedEnvelope, type OrderPending, type OrderPlaced, type OrderRefunded, type OrderRejected, type OrderRejectedEventOrderRejected, OrderStatus, type OrderTaxBreakdown, type OrderTaxInfo, type OrderTransactions, type OrderUpdatedEnvelope, type OrdersExperiments, type Payment, type PaymentCanceled, type PaymentCanceledPaymentDetailsOneOf, type PaymentCapture, PaymentCollectabilityStatus, type PaymentDeclined, type PaymentDeclinedPaymentDetailsOneOf, PaymentOptionType, type PaymentPaymentDetailsOneOf, type PaymentPending, type PaymentPendingPaymentDetailsOneOf, type PaymentRefund, type PaymentRefundFailed, type PaymentRefunded, PaymentStatus, type PaymentStatusUpdated, type Payments, type Phone, type PhysicalProperties, type PickupAddress, type PickupDetails, PickupMethod, type PickupReadyEmailSent, Placement, type PlainTextValue, type PlatformPaging, type PlatformPagingMetadata, type PlatformQuery, type PlatformQueryPagingMethodOneOf, type PreparePaymentCollectionOptions, type PreparePaymentCollectionRequest, type PreparePaymentCollectionResponse, type PreparePaymentCollectionResponseNonNullableFields, type PreviewBuyerConfirmationEmailRequest, type PreviewBuyerConfirmationEmailResponse, type PreviewBuyerPaymentsReceivedEmailRequest, type PreviewBuyerPaymentsReceivedEmailResponse, type PreviewBuyerPickupConfirmationEmailRequest, type PreviewBuyerPickupConfirmationEmailResponse, type PreviewCancelEmailRequest, type PreviewCancelEmailResponse, type PreviewCancelRefundEmailRequest, type PreviewCancelRefundEmailResponse, type PreviewEmailByTypeRequest, type PreviewEmailByTypeResponse, PreviewEmailType, type PreviewRefundEmailRequest, type PreviewRefundEmailResponse, type PreviewResendDownloadLinksEmailRequest, type PreviewResendDownloadLinksEmailResponse, type PreviewShippingConfirmationEmailRequest, type PreviewShippingConfirmationEmailResponse, type Price, type PriceDescription, type PriceSummary, type ProductName, type PublicActivity, type PublicActivityContentOneOf, type QueryOrderRequest, type QueryOrderResponse, type QueryOrdersForMetasiteRequest, type QueryOrdersForMetasiteResponse, type QuotesAddress, Reason, type RecordManuallyCollectedPaymentRequest, type RecordManuallyCollectedPaymentResponse, type RedirectUrls, type Refund, type RefundCreated, type RefundDetails, type RefundInitiated, type RefundItem, type RefundSideEffects, RefundStatus, type RefundTransaction, type Refundability, type RefundabilityAdditionalRefundabilityInfoOneOf, RefundableStatus, type RefundedAsStoreCredit, type RefundedPayment, type RefundedPaymentKindOneOf, type RegularPayment, type RegularPaymentDetails, type RegularPaymentDetailsPaymentMethodDetailsOneOf, type RegularPaymentPaymentMethodDetailsOneOf, type RegularPaymentRefund, type Reschedule, type RestockInfo, type RestockItem, RestockType, type RestoreInfo, type SavedPaymentMethod, ScheduledAction, type SearchOrdersOptions, type SearchOrdersRequest, type SearchOrdersResponse, type SearchOrdersResponseNonNullableFields, type SendBuyerConfirmationEmailRequest, type SendBuyerConfirmationEmailResponse, type SendBuyerPaymentsReceivedEmailRequest, type SendBuyerPaymentsReceivedEmailResponse, type SendBuyerPickupConfirmationEmailRequest, type SendBuyerPickupConfirmationEmailResponse, type SendBuyerShippingConfirmationEmailRequest, type SendBuyerShippingConfirmationEmailResponse, type SendCancelRefundEmailRequest, type SendCancelRefundEmailResponse, type SendMerchantOrderReceivedNotificationRequest, type SendMerchantOrderReceivedNotificationResponse, type SendMerchantOrderReceivedPushRequest, type SendMerchantOrderReceivedPushResponse, type SendRefundEmailRequest, type SendRefundEmailResponse, type SeoData, type ServiceProperties, type ShippingAddressEdited, type ShippingConfirmationEmailSent, type ShippingInformation, type ShippingInformationChange, type ShippingPrice, type ShippingRefund, type ShippingRegion, type SnapshotMessage, SortOrder, type Sorting, type Source, SourceType, type StandardDetails, State, type StreetAddress, type Subdivision, SubdivisionType, SubscriptionFrequency, type SubscriptionInfo, type SubscriptionSettings, type TagList, type Tags, type Task, type TaskAction, type TaskActionActionOneOf, type TaskKey, type TaxSummary, type TaxableAddress, type TaxableAddressTaxableAddressDataOneOf, TaxableAddressType, type TotalPrice, type TotalPriceChange, type TrackingLinkAdded, type TrackingNumberAdded, type TrackingNumberEdited, TransactionStatus, type TranslatedValue, type TriggerRefundRequest, type TriggerRefundResponse, type TriggerReindexOrderRequest, type TriggerReindexRequest, type TriggerReindexResponse, type TriggerSideEffectsFromLegacyData, type UnArchiveOrderRequest, type UnArchiveOrderResponse, type UpdateActivityRequest, type UpdateActivityResponse, type UpdateBillingContactDetailsRequest, type UpdateBillingContactDetailsResponse, type UpdateBuyerEmailRequest, type UpdateBuyerEmailResponse, type UpdateBuyerInfoRequest, type UpdateBuyerInfoResponse, type UpdateInternalDocumentsEvent, type UpdateInternalDocumentsEventOperationOneOf, type UpdateLineItemsDescriptionLinesRequest, type UpdateLineItemsDescriptionLinesResponse, type UpdateOrder, type UpdateOrderLineItemRequest, type UpdateOrderLineItemResponse, type UpdateOrderLineItemsRequest, type UpdateOrderLineItemsResponse, type UpdateOrderRequest, type UpdateOrderResponse, type UpdateOrderResponseNonNullableFields, type UpdateOrderShippingAddressRequest, type UpdateOrderShippingAddressResponse, type UpsertRefundRequest, type UpsertRefundResponse, type UserDataResponse, type V1BulkMarkOrdersAsPaidRequest, type V1BulkMarkOrdersAsPaidResponse, type V1CreatePaymentGatewayOrderRequest, type V1CreatePaymentGatewayOrderResponse, type V1LineItemDelta, type V1LineItemDeltaDeltaOneOf, type V1MarkOrderAsPaidRequest, type V1MarkOrderAsPaidResponse, type V1RestockItem, type V1ScheduledAction, type V1ShippingInformation, type Value, ValueType, type VatId, VatType, type VersionedDeleteByIdsOperation, type VersionedDocumentId, type VersionedDocumentUpdateOperation, VersioningMode, type VoidAuthorizedPaymentsRequest, type VoidAuthorizedPaymentsResponse, type VoidAuthorizedPaymentsResponseNonNullableFields, WebhookIdentityType, WeightUnit, bulkUpdateOrderTags, bulkUpdateOrders, cancelOrder, captureAuthorizedPayments, createOrder, getOrder, getPaymentCollectabilityStatus, onOrderApproved, onOrderCanceled, onOrderCreated, onOrderPaymentStatusUpdated, onOrderUpdated, preparePaymentCollection, searchOrders, updateOrder, voidAuthorizedPayments };
