 ...
 */
declare function calculateTotals(options?: CalculateTotalsOptions): Promise<CalculateTotalsResponse & CalculateTotalsResponseNonNullableFields>;
...
export { type AdditionalFee, type Address, type AddressLocation, type AggregatedTaxBreakdown, type ApplicationError, type AppliedDiscount, type AppliedDiscountDiscountSourceOneOf, type AutoTaxFallbackCalculationDetails, type CalculateTotalsOptions, type CalculateTotalsRequest, type CalculateTotalsRequestCouponOneOf, type CalculateTotalsRequestGiftCardOneOf, type CalculateTotalsResponse, type CalculateTotalsResponseNonNullableFields, type CalculatedLineItem, type CalculationErrors, type CalculationErrorsShippingCalculationErrorOneOf, type CarrierError, type CarrierErrors, type CarrierServiceOption, type CarrierShippingOption, type CatalogReference, ChargeType, type Coupon, DataFetchType, type DeliveryLogistics, type DeliveryTimeSlot, type Details, type DetailsKindOneOf, type DiscountRule, type DiscountRuleName, DiscountType, type ExternalReference, FallbackReason, type FieldViolation, type GiftCard, type Group, type InvalidMembership, type ItemTaxFullDetails, type ItemType, ItemTypeItemType, type ItemTypeItemTypeDataOneOf, JurisdictionType, type LineItem, type LineItemDiscount, type LineItemPricesData, ManualCalculationReason, type Membership, type MembershipName, type MembershipOptions, type MembershipPaymentCredits, type MerchantDiscount, type MerchantDiscountInput, type MultiCurrencyPrice, type OtherCharge, PaymentOptionType, type PhysicalProperties, type PickupDetails, PickupMethod, type PriceSummary, RateType, RuleType, type Scope, type SelectedCarrierServiceOption, type SelectedCarrierServiceOptionOtherCharge, type SelectedCarrierServiceOptionPrices, type SelectedMembership, type SelectedMemberships, type SelectedShippingOption, type ServiceProperties, type ShippingInformation, type ShippingOption, type ShippingPrice, type ShippingRegion, type StreetAddress, SubscriptionFrequency, type SubscriptionSettings, type SystemError, type TaxBreakdown, type TaxCalculationDetails, type TaxCalculationDetailsCalculationDetailsOneOf, type TaxDetails, type TaxRateBreakdown, type TaxSummary, type TaxableAddress, type TaxableAddressTaxableAddressDataOneOf, TaxableAddressType, type TotalsCalculationEntity, type V1AdditionalFee, type ValidationError, WeightUnit, calculateTotals };
