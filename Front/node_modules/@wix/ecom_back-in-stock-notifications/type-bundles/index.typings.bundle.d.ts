 ...
 */
declare function onBackInStockNotificationRequestCreated(handler: (event: BackInStockNotificationRequestCreatedEnvelope) => void | Promise<void>): void;
 ...
 * @documentationMaturity preview
 */
declare function onBackInStockNotificationRequestDeleted(handler: (event: BackInStockNotificationRequestDeletedEnvelope) => void | Promise<void>): void;
 ...
 * @documentationMaturity preview
 */
declare function onBackInStockNotificationRequestUpdated(handler: (event: BackInStockNotificationRequestUpdatedEnvelope) => void | Promise<void>): void;
/**
 ...
 */
declare function createBackInStockNotificationRequest(request: BackInStockNotificationRequest, itemDetails: BackInStockItemDetails): Promise<BackInStockNotificationRequest & BackInStockNotificationRequestNonNullableFields>;
/**
 ...
 */
declare function getBackInStockNotificationRequest(_id: string): Promise<BackInStockNotificationRequest & BackInStockNotificationRequestNonNullableFields>;
/**
 ...
 * @applicableIdentity APP
 */
declare function deleteBackInStockNotificationRequest(_id: string): Promise<void>;
/**
 ...
 * @applicableIdentity APP
 */
declare function markAsNotificationSent(_id: string): Promise<MarkAsNotificationSentResponse & MarkAsNotificationSentResponseNonNullableFields>;
/**
 ...
 * @applicableIdentity APP
 */
declare function queryBackInStockNotificationRequests(): RequestsQueryBuilder;
 ...
 * @applicableIdentity APP
 */
declare function getBackInStockNotificationRequestsCountByCatalogReferences(catalogReferences: CatalogReference[]): Promise<GetBackInStockNotificationRequestsCountByCatalogReferencesResponse & GetBackInStockNotificationRequestsCountByCatalogReferencesResponseNonNullableFields>;
/**
 ...
 * @applicableIdentity APP
 */
declare function reportItemsBackInStock(itemDetails: BackInStockItemDetails, options?: ReportItemsBackInStockOptions): Promise<void>;
...
export { type ActionEvent, type App, type BackInStockItemDetails, type BackInStockNotificationRequest, type BackInStockNotificationRequestCreatedEnvelope, type BackInStockNotificationRequestDeletedEnvelope, type BackInStockNotificationRequestNonNullableFields, type BackInStockNotificationRequestUpdatedEnvelope, type BackInStockNotificationRequestsCount, type BaseEventMetadata, type CatalogReference, type CreateBackInStockNotificationRequestRequest, type CreateBackInStockNotificationRequestResponse, type CreateBackInStockNotificationRequestResponseNonNullableFields, type CursorPaging, type Cursors, type DeleteBackInStockNotificationRequestRequest, type DeleteBackInStockNotificationRequestResponse, type DomainEvent, type DomainEventBodyOneOf, type Empty, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, type EventMetadata, type File, type GetBackInStockNotificationRequestRequest, type GetBackInStockNotificationRequestResponse, type GetBackInStockNotificationRequestResponseNonNullableFields, type GetBackInStockNotificationRequestsCountByCatalogReferencesRequest, type GetBackInStockNotificationRequestsCountByCatalogReferencesResponse, type GetBackInStockNotificationRequestsCountByCatalogReferencesResponseNonNullableFields, type IdentificationData, type IdentificationDataIdOneOf, type InvalidateCache, type InvalidateCacheGetByOneOf, type MarkAsNotificationSentRequest, type MarkAsNotificationSentResponse, type MarkAsNotificationSentResponseNonNullableFields, type MessageEnvelope, type Page, type PlatformPaging, type PlatformPagingMetadata, type PlatformQuery, type PlatformQueryPagingMethodOneOf, type QueryBackInStockNotificationRequestsRequest, type QueryBackInStockNotificationRequestsResponse, type QueryBackInStockNotificationRequestsResponseNonNullableFields, type ReportItemsBackInStockOptions, type ReportItemsBackInStockRequest, type ReportItemsBackInStockResponse, type RequestsQueryBuilder, type RequestsQueryResult, type RestoreInfo, SortOrder, type Sorting, Status, type URI, WebhookIdentityType, createBackInStockNotificationRequest, deleteBackInStockNotificationRequest, getBackInStockNotificationRequest, getBackInStockNotificationRequestsCountByCatalogReferences, markAsNotificationSent, onBackInStockNotificationRequestCreated, onBackInStockNotificationRequestDeleted, onBackInStockNotificationRequestUpdated, queryBackInStockNotificationRequests, reportItemsBackInStock };
