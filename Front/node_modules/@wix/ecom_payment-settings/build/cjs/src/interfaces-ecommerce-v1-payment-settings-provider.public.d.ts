...
import { Context, GetPaymentSettingsRequest, GetPaymentSettingsResponse, GetPaymentSettingsForCheckoutRequest, GetPaymentSettingsForCheckoutResponse } from './service-plugins-types';
export interface GetPaymentSettingsEnvelope {
    request: GetPaymentSettingsRequest;
    metadata: Context;
}
export interface GetPaymentSettingsForCheckoutEnvelope {
