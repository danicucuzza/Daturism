 ...
 */
declare function getOrdersSettings(): Promise<GetOrdersSettingsResponse & GetOrdersSettingsResponseNonNullableFields>;
/**
 ...
 */
declare function updateOrdersSettings(ordersSettings: OrdersSettings): Promise<UpdateOrdersSettingsResponse & UpdateOrdersSettingsResponseNonNullableFields>;

export { type ActionEvent, type BaseEventMetadata, type DeleteOrdersSettingsRequest, type DeleteOrdersSettingsResponse, type DomainEvent, type DomainEventBodyOneOf, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, type EventMetadata, type GetOrdersSettingsRequest, type GetOrdersSettingsResponse, type GetOrdersSettingsResponseNonNullableFields, type IdentificationData, type IdentificationDataIdOneOf, InventoryUpdateTrigger, type ListOrdersSettingsRequest, type ListOrdersSettingsResponse, type MessageEnvelope, type OrdersSettings, type OrdersSettingsUpdatedEnvelope, type RestoreInfo, type UpdateOrdersSettingsRequest, type UpdateOrdersSettingsResponse, type UpdateOrdersSettingsResponseNonNullableFields, WebhookIdentityType, getOrdersSettings, onOrdersSettingsUpdated, updateOrdersSettings };
