 ...
 *
 * This endpoint is only for updating the quantity of line items.
 * To entirely remove a line item from the current cart, use [Remove Line Items From Current Cart](https://dev.wix.com/docs/rest/business-solutions/e-commerce/cart/remove-line-items-from-current-cart).
 * To add a new line item to the current cart, use [Add To Current Cart](https://dev.wix.com/docs/rest/business-solutions/e-commerce/cart/add-to-current-cart).
 *
