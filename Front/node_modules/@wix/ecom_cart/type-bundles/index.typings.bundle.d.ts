 ...
 */
declare function createCart(options?: CreateCartOptions): Promise<Cart & CartNonNullableFields>;
 ...
 */
declare function updateCart(_id: string | null, options?: UpdateCartOptions): Promise<Cart & CartNonNullableFields>;
 ...
 */
declare function getCart(_id: string): Promise<Cart & CartNonNullableFields>;
/**
 ...
 * @returns Fulfilled - Cart.
 */
declare function addToCart(_id: string, options?: AddToCartOptions): Promise<AddToCartResponse & AddToCartResponseNonNullableFields>;
 ...
 * @returns Fulfilled - Updated cart.
 */
declare function removeLineItems(_id: string, lineItemIds: string[]): Promise<RemoveLineItemsResponse & RemoveLineItemsResponseNonNullableFields>;
/**
 ...
 */
declare function createCheckout(_id: string, options?: CreateCheckoutOptions): Promise<CreateCheckoutResponse & CreateCheckoutResponseNonNullableFields>;
 ...
 * @returns Fulfilled - Updated cart.
 */
declare function removeCoupon(_id: string): Promise<RemoveCouponResponse & RemoveCouponResponseNonNullableFields>;
/**
 ...
 * @returns Fulfilled - Updated cart.
 */
declare function updateLineItemsQuantity(_id: string, lineItems: LineItemQuantityUpdate[]): Promise<UpdateLineItemsQuantityResponse & UpdateLineItemsQuantityResponseNonNullableFields>;
/**
 ...
 */
declare function estimateTotals(_id: string, options?: EstimateTotalsOptions): Promise<EstimateTotalsResponse & EstimateTotalsResponseNonNullableFields>;
...
export { type ActionEvent, type AddToCartOptions, type AddToCartRequest, type AddToCartResponse, type AddToCartResponseNonNullableFields, type AddToCurrentCartAndEstimateTotalsRequest, type AddToCurrentCartRequest, type AdditionalFee, type Address, type AddressLocation, type AddressWithContact, type AggregatedTaxBreakdown, type ApplicationError, type AppliedDiscount, type AppliedDiscountDiscountSourceOneOf, type AutoTaxFallbackCalculationDetails, type BaseEventMetadata, type BuyerInfo, type BuyerInfoIdOneOf, type CalculatedLineItem, type CalculationErrors, type CalculationErrorsShippingCalculationErrorOneOf, type CarrierError, type CarrierErrors, type CarrierServiceOption, type Cart, type CartCreatedEnvelope, type CartDeletedEnvelope, type CartDiscount, type CartDiscountDiscountSourceOneOf, type CartNonNullableFields, type CartUpdatedEnvelope, type CatalogOverrideFields, type CatalogReference, ChannelType, ChargeType, type Color, type Coupon, type CreateCartOptions, type CreateCartRequest, type CreateCartResponse, type CreateCartResponseNonNullableFields, type CreateCheckoutFromCurrentCartRequest, type CreateCheckoutOptions, type CreateCheckoutRequest, type CreateCheckoutResponse, type CreateCheckoutResponseNonNullableFields, type CustomLineItem, type DeleteCartRequest, type DeleteCartResponse, type DeleteCurrentCartRequest, type DeliveryLogistics, type DeliveryTimeSlot, type Description, type DescriptionLine, type DescriptionLineDescriptionLineValueOneOf, type DescriptionLineName, DescriptionLineType, type DescriptionLineValueOneOf, type Details, type DetailsKindOneOf, type DiscountRule, type DiscountRuleName, DiscountType, type DomainEvent, type DomainEventBodyOneOf, type Empty, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, type EstimateCurrentCartTotalsRequest, type EstimateTotalsOptions, type EstimateTotalsRequest, type EstimateTotalsResponse, type EstimateTotalsResponseNonNullableFields, type EventMetadata, type ExtendedFields, FallbackReason, type FieldViolation, FileType, type FreeTrialPeriod, type FullAddressContactDetails, type GetCartByCheckoutIdRequest, type GetCartByCheckoutIdResponse, type GetCartRequest, type GetCartResponse, type GetCartResponseNonNullableFields, type GetCurrentCartRequest, type GetCurrentCartResponse, type GetCurrentCartResponseNonNullableFields, type GiftCard, type Group, type HostSelectedMembership, type IdentificationData, type IdentificationDataIdOneOf, type InvalidMembership, type ItemAvailabilityInfo, ItemAvailabilityStatus, type ItemTaxFullDetails, type ItemType, ItemTypeItemType, type ItemTypeItemTypeDataOneOf, JurisdictionType, type LineItem, type LineItemDiscount, type LineItemPricesData, type LineItemQuantityUpdate, ManualCalculationReason, type Membership, type MembershipName, type MembershipOptions, type MembershipPaymentCredits, type MerchantDiscount, type MerchantDiscountInput, type MessageEnvelope, type MultiCurrencyPrice, NameInLineItem, NameInOther, type Other, type OtherCharge, type PaymentOption, PaymentOptionType, type PhysicalProperties, type PickupDetails, PickupMethod, type PlainTextValue, type Policy, type PriceDescription, type PriceSummary, type ProductName, RateType, type RemoveCouponFromCurrentCartRequest, type RemoveCouponRequest, type RemoveCouponResponse, type RemoveCouponResponseNonNullableFields, type RemoveLineItemsFromCurrentCartRequest, type RemoveLineItemsRequest, type RemoveLineItemsResponse, type RemoveLineItemsResponseNonNullableFields, type RestoreInfo, RuleType, type Scope, type SecuredMedia, type SelectedCarrierServiceOption, type SelectedCarrierServiceOptionOtherCharge, type SelectedCarrierServiceOptionPrices, type SelectedMembership, type SelectedMemberships, type SelectedShippingOption, type ServiceProperties, Severity, type ShippingInformation, type ShippingOption, type ShippingPrice, type ShippingRegion, type StreetAddress, SubscriptionFrequency, type SubscriptionOptionInfo, type SubscriptionSettings, SuggestedFix, type SystemError, type Target, type TargetLineItem, type TargetTargetTypeOneOf, type TaxBreakdown, type TaxCalculationDetails, type TaxCalculationDetailsCalculationDetailsOneOf, type TaxRateBreakdown, type TaxSummary, type TaxableAddress, type TaxableAddressTaxableAddressDataOneOf, TaxableAddressType, type Title, type UpdateCartOptions, type UpdateCartRequest, type UpdateCartResponse, type UpdateCartResponseNonNullableFields, type UpdateCurrentCartLineItemQuantityRequest, type UpdateLineItemsQuantityRequest, type UpdateLineItemsQuantityResponse, type UpdateLineItemsQuantityResponseNonNullableFields, type V1Coupon, type V1MerchantDiscount, type ValidationError, type VatId, VatType, type Violation, WebhookIdentityType, WeightUnit, addToCart, createCart, createCheckout, deleteCart, estimateTotals, getCart, onCartCreated, onCartDeleted, onCartUpdated, removeCoupon, removeLineItems, updateCart, updateLineItemsQuantity };
