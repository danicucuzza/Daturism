    ...
    function __createDraftOrder({ host }) {
        const metadata = {
            ...
            url: resolveComWixEcomOrdersDraftV1DraftOrdersUrl({
                protoPath: '/v1/draft-orders/{orderId}/create-draft-order',
                data: payload,
                host,
            }),
            data: payload,
    ...
    function __addLineItemsToDraftOrder({ host }) {
        const serializedData = (0, transform_paths_1.transformPaths)(payload, [
            ...
            },
            {
                ...
                paths: [{ path: 'customLineItems.physicalProperties.weight' }],
            },
        ]);
        const metadata = {
            entityFqdn: 'wix.ecom.v1.draft_order',
...
function createCustomDiscounts(payload) {
    function __createCustomDiscounts({ host }) {
        const metadata = {
            ...
            packageName: PACKAGE_NAME,
            url: resolveComWixEcomOrdersDraftV1DraftOrdersUrl({
                protoPath: '/v1/draft-orders/{draftOrderId}/add-discounts',
                data: payload,
                host,
            }),
            data: payload,
...
function deleteCustomDiscounts(payload) {
    function __deleteCustomDiscounts({ host }) {
        const metadata = {
            ...
            packageName: PACKAGE_NAME,
            url: resolveComWixEcomOrdersDraftV1DraftOrdersUrl({
                protoPath: '/v1/draft-orders/{draftOrderId}/remove-discounts',
                data: payload,
                host,
            }),
            data: payload,
...
function deleteCustomAdditionalFees(payload) {
    function __deleteCustomAdditionalFees({ host }) {
        const metadata = {
            ...
            packageName: PACKAGE_NAME,
            url: resolveComWixEcomOrdersDraftV1DraftOrdersUrl({
                protoPath: '/v1/draft-orders/{draftOrderId}/remove-additional-fees',
                data: payload,
                host,
            }),
            data: payload,
...
function getDraftOrder(payload) {
    function __getDraftOrder({ host }) {
        const metadata = {
            ...
            packageName: PACKAGE_NAME,
            url: resolveComWixEcomOrdersDraftV1DraftOrdersUrl({
                protoPath: '/v1/draft-orders/{draftOrderId}/get',
                data: payload,
                host,
            }),
