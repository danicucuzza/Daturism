 ...
 */
declare function createDraftOrder(orderId: string | null): Promise<CreateDraftOrderResponse & CreateDraftOrderResponseNonNullableFields>;
/**
 ...
 * @applicableIdentity APP
 */
declare function createEmptyDraftOrder(): Promise<CreateEmptyDraftOrderResponse & CreateEmptyDraftOrderResponseNonNullableFields>;
/**
 ...
 * @applicableIdentity APP
 */
declare function addLineItemsToDraftOrder(draftOrderId: string, options?: AddLineItemsToDraftOrderOptions): Promise<AddLineItemsToDraftOrderResponse & AddLineItemsToDraftOrderResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function updateLineItems(draftOrderId: string, options?: UpdateLineItemsOptions): Promise<UpdateLineItemsResponse & UpdateLineItemsResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function setDiscounts(draftOrderId: string, discounts: IdAndApplied[]): Promise<SetDiscountsResponse & SetDiscountsResponseNonNullableFields>;
/**
 ...
 * @applicableIdentity APP
 */
declare function createCustomDiscounts(draftOrderId: string, options?: CreateCustomDiscountsOptions): Promise<CreateCustomDiscountsResponse & CreateCustomDiscountsResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function deleteCustomDiscounts(draftOrderId: string, discountIds: string[]): Promise<DeleteCustomDiscountsResponse & DeleteCustomDiscountsResponseNonNullableFields>;
/**
 ...
 * @applicableIdentity APP
 */
declare function setAdditionalFees(draftOrderId: string, additionalFees: IdAndApplied[]): Promise<SetAdditionalFeesResponse & SetAdditionalFeesResponseNonNullableFields>;
/**
 ...
 * @applicableIdentity APP
 */
declare function createCustomAdditionalFees(draftOrderId: string, options?: CreateCustomAdditionalFeesOptions): Promise<CreateCustomAdditionalFeesResponse & CreateCustomAdditionalFeesResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function deleteCustomAdditionalFees(draftOrderId: string, customAdditionalFees: string[]): Promise<DeleteCustomAdditionalFeesResponse & DeleteCustomAdditionalFeesResponseNonNullableFields>;
/**
 ...
 * @applicableIdentity APP
 */
declare function setShippingInfo(): Promise<void>;
/**
 ...
 * @applicableIdentity APP
 */
declare function setBuyerInfo(): Promise<void>;
/**
 ...
 * @applicableIdentity APP
 */
declare function setRecipientInfo(): Promise<void>;
/**
 ...
 * @applicableIdentity APP
 */
declare function setBillingInfo(): Promise<void>;
/**
 * Get an order.
 ...
 * @applicableIdentity APP
 */
declare function getDraftOrder(draftOrderId: string): Promise<GetDraftOrderResponse & GetDraftOrderResponseNonNullableFields>;
/**
 ...
 * @applicableIdentity APP
 */
declare function getOrderDraftabilityStatus(orderId: string): Promise<GetOrderDraftabilityStatusResponse & GetOrderDraftabilityStatusResponseNonNullableFields>;
/**
 ...
 * @applicableIdentity APP
 */
declare function commitDraftOrder(draftOrderId: string, options?: CommitDraftOrderOptions): Promise<CommitDraftOrderResponse & CommitDraftOrderResponseNonNullableFields>;
 ...
 * @applicableIdentity APP
 */
declare function createOrderFromDraft(): Promise<void>;
/**
...
export { type ActionEvent, type Activity, type ActivityContentOneOf, ActivityType, type AddLineItemsToDraftOrderOptions, type AddLineItemsToDraftOrderRequest, type AddLineItemsToDraftOrderResponse, type AddLineItemsToDraftOrderResponseNonNullableFields, type AdditionalFee, type AdditionalFeeDetails, type AdditionalFeeOption, type Address, type AddressLocation, type AddressWithContact, type ApplicationError, type AppliedDiscount, type AppliedDiscountDiscountSourceOneOf, AppliedDiscountDiscountType, AttributionSource, type AuthorizedPaymentCaptured, type AuthorizedPaymentCreated, type AuthorizedPaymentVoided, type Balance, type BalanceSummary, type BillingChangedDetails, type BillingDetails, type BillingDetailsChangeTypeOneOf, type BuyerChangedDetails, type BuyerDetails, type BuyerDetailsChangeTypeOneOf, type BuyerInfo, type BuyerInfoIdOneOf, type CalculatedDraftOrder, type CalculationErrors, type CalculationErrorsShippingCalculationErrorOneOf, type CarrierError, type CarrierErrors, type CatalogReference, type CatalogReferenceLineItem, type ChannelInfo, ChannelType, type Color, type CommitDraftOrderOptions, type CommitDraftOrderRequest, type CommitDraftOrderResponse, type CommitDraftOrderResponseNonNullableFields, type Coupon, type CreateCustomAdditionalFeesOptions, type CreateCustomAdditionalFeesRequest, type CreateCustomAdditionalFeesResponse, type CreateCustomAdditionalFeesResponseNonNullableFields, type CreateCustomDiscountsOptions, type CreateCustomDiscountsRequest, type CreateCustomDiscountsResponse, type CreateCustomDiscountsResponseNonNullableFields, type CreateDraftOrderRequest, type CreateDraftOrderResponse, type CreateDraftOrderResponseNonNullableFields, type CreateEmptyDraftOrderRequest, type CreateEmptyDraftOrderResponse, type CreateEmptyDraftOrderResponseNonNullableFields, type CreateOrderFromDraftRequest, type CreateOrderFromDraftResponse, type CreateOrderFromDraftResponseNonNullableFields, type CreatedBy, type CreatedByStringOneOf, type CreditCardDetails, type CursorPaging, type CursorPagingMetadata, type CursorQuery, type CursorQueryPagingMethodOneOf, type Cursors, type CustomActivity, type CustomField, type CustomLineItem, type DeleteCustomAdditionalFeesRequest, type DeleteCustomAdditionalFeesResponse, type DeleteCustomAdditionalFeesResponseNonNullableFields, type DeleteCustomDiscountsRequest, type DeleteCustomDiscountsResponse, type DeleteCustomDiscountsResponseNonNullableFields, type DeleteDraftOrderRequest, type DeleteDraftOrderResponse, type DeliveryLogistics, type DeliveryTimeSlot, type DescriptionLine, type DescriptionLineDescriptionLineValueOneOf, type DescriptionLineName, DescriptionLineType, type DescriptionLineValueOneOf, type Details, type DetailsKindOneOf, type DigitalFile, type DiscountDetails, type DiscountOption, type DiscountOptionDiscountAmountOneOf, DiscountReason, type DiscountRule, type DiscountRuleName, DiscountType, type DomainEvent, type DomainEventBodyOneOf, type DraftOrder, type DraftOrderChangesApplied, type DraftOrderCommitSettings, type DraftOrdersQueryBuilder, type DraftOrdersQueryResult, EditingStatus, type EntityCreatedEvent, type EntityDeletedEvent, type EntityUpdatedEvent, type ExtendedFields, type FieldViolation, FileType, FulfillmentStatus, type FulfillmentStatusesAggregate, type FullAddressContactDetails, type GetDraftEditabilityStatusRequest, type GetDraftEditabilityStatusResponse, type GetDraftOrderRequest, type GetDraftOrderResponse, type GetDraftOrderResponseNonNullableFields, type GetOrderDraftabilityStatusRequest, type GetOrderDraftabilityStatusResponse, type GetOrderDraftabilityStatusResponseNonNullableFields, type GiftCardPaymentRefund, type IdAndApplied, type IdentificationData, type IdentificationDataIdOneOf, type InventoryUpdate, type ItemChangedDetails, type ItemDetails, type ItemDetailsChangeTypeOneOf, type ItemTaxFullDetails, type ItemType, ItemTypeItemType, type ItemTypeItemTypeDataOneOf, JurisdictionType, type LineItemAmount, type LineItemChangeDetails, type LineItemChanges, type LineItemDiscount, type LineItemExchangeData, type LineItemPriceChange, type LineItemQuantityChange, LineItemQuantityChangeType, type LineItemTaxBreakdown, type LineItemTaxInfo, type LocationAndQuantity, type ManagedAdditionalFee, type ManagedDiscount, type ManagedLineItem, type MembershipPaymentRefund, type MerchantComment, type MerchantDiscount, type MerchantDiscountMerchantDiscountReasonOneOf, type MessageEnvelope, type NewExchangeOrderCreated, NonDraftableReason, type Order, type OrderChange, type OrderChangeValueOneOf, type OrderCreateNotifications, type OrderCreateSettings, type OrderCreatedFromExchange, type OrderLineItem, type OrderRefunded, OrderStatus, type OrderTaxBreakdown, type OrderTaxInfo, type PaymentCanceled, type PaymentCanceledPaymentDetailsOneOf, type PaymentDeclined, type PaymentDeclinedPaymentDetailsOneOf, PaymentOptionType, type PaymentPending, type PaymentPendingPaymentDetailsOneOf, type PaymentRefundFailed, type PaymentRefunded, PaymentStatus, type PhysicalProperties, type PickupAddress, type PickupDetails, PickupDetailsPickupMethod, PickupMethod, type PlainTextValue, type Price, type PriceDescription, type PriceSummary, type ProductName, type QueryDraftOrdersRequest, type QueryDraftOrdersResponse, type QueryDraftOrdersResponseNonNullableFields, type RecipientInfoChangedDetails, type RecipientInfoDetails, type RecipientInfoDetailsChangeTypeOneOf, type RefundInitiated, type RefundedAsStoreCredit, type RefundedPayment, type RefundedPaymentKindOneOf, type RegularPayment, type RegularPaymentPaymentMethodDetailsOneOf, type RegularPaymentRefund, type RestoreInfo, RuleType, type SavedPaymentMethod, type SecuredMedia, type SetAdditionalFeesRequest, type SetAdditionalFeesResponse, type SetAdditionalFeesResponseNonNullableFields, type SetBillingInfoRequest, type SetBillingInfoResponse, type SetBillingInfoResponseNonNullableFields, type SetBuyerInfoRequest, type SetBuyerInfoResponse, type SetBuyerInfoResponseNonNullableFields, type SetDiscountsRequest, type SetDiscountsResponse, type SetDiscountsResponseNonNullableFields, type SetRecipientInfoRequest, type SetRecipientInfoResponse, type SetRecipientInfoResponseNonNullableFields, type SetShippingInfoRequest, type SetShippingInfoResponse, type SetShippingInfoResponseNonNullableFields, type SetTaxExemptionRequest, type SetTaxExemptionResponse, type ShippingChangedDetails, type ShippingDetails, type ShippingDetailsChangeTypeOneOf, type ShippingInformation, type ShippingInformationChange, type ShippingOption, type ShippingPrice, type ShippingRegion, SortOrder, type Sorting, SourceType, type StreetAddress, SubscriptionFrequency, type SubscriptionInfo, type SubscriptionSettings, type SystemError, type TagList, type Tags, type TaxDetails, type TaxSummary, type TaxableAddress, type TaxableAddressTaxableAddressDataOneOf, TaxableAddressType, type TotalPriceChange, type TranslatedValue, type UpdateExtendedFieldsRequest, type UpdateExtendedFieldsResponse, type UpdateLineItemsOptions, type UpdateLineItemsRequest, type UpdateLineItemsResponse, type UpdateLineItemsResponseNonNullableFields, type UpdateShippingInfoRequest, type UpdateShippingInfoResponse, type V1BalanceSummary, type V1CreatedBy, type V1CreatedByStringOneOf, type V1DeliveryLogistics, type V1DeliveryLogisticsAddressOneOf, type V1DeliveryTimeSlot, type V1PickupDetails, type V1ShippingInformation, type V1ShippingPrice, type ValidationError, type VatId, VatType, WebhookIdentityType, WeightUnit, addLineItemsToDraftOrder, commitDraftOrder, createCustomAdditionalFees, createCustomDiscounts, createDraftOrder, createEmptyDraftOrder, createOrderFromDraft, deleteCustomAdditionalFees, deleteCustomDiscounts, deleteDraftOrder, getDraftOrder, getOrderDraftabilityStatus, queryDraftOrders, setAdditionalFees, setBillingInfo, setBuyerInfo, setDiscounts, setRecipientInfo, setShippingInfo, updateLineItems };
