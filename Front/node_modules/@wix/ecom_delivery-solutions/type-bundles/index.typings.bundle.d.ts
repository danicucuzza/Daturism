 ...
 * on Errors throw a business error from TC to catch and trigger destination completion
 */
declare function getDeliverySolutions(lineItems: DeliverableItem[], options?: GetDeliverySolutionsOptions): Promise<GetDeliverySolutionsResponse & GetDeliverySolutionsResponseNonNullableFields>;
